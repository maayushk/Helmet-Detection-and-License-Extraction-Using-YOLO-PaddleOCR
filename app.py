...
if input_type == "Image":
    ...
    if uploaded_file is not None:
        ...
        with st.spinner("Running detection..."):
            ...
            plate_results  = plate_model.predict(img_bgr, conf=0.25)
        ...
        for box in helmet_results[0].boxes:
            ...
            plate_crop, extracted_text = find_nearest_plate(box, plate_results[0].boxes, img_bgr)
...
# ════════════════════════════════════════════
    ...
    if uploaded_video is not None:
        ...
        while cap.isOpened():
            ...
            # ── Run detection ─────────────────────────────────────────────
            helmet_results = helmet_model.predict(frame, conf=0.60, verbose=False)
            ...
            no_helmet_boxes = [b for b in helmet_results[0].boxes if int(b.cls[0]) == 3]
